    ...
    <div class="offcanvas offcanvas-start" id="mobileSidebar" tabindex="-1" aria-labelledby="mobileSidebarLabel" 
        ...
        <div class="offcanvas-body p-0 d-flex flex-column">
            ...
            <nav class="nav flex-column flex-grow-1">
                ...
                <button class="nav-link nav-item-lms" data-section="book" onclick="showSection(this); closeOffcanvas();">
                ...
                <button class="nav-link nav-item-lms" data-section="borrowed" onclick="showSection(this); closeOffcanvas();">
                    ...
                    <span class="description">Borrowed Books</span> <span class="right-align"> > </span>
                </button>
                ...
                <button class="nav-link nav-item-lms" data-section="toreturn" onclick="showSection(this); closeOffcanvas();">
                    ...
                    <span class="description">To Return Books</span> <span class="right-align"> > </span>
                </button>

                <button class="nav-link nav-item-lms" data-section="returned" onclick="showSection(this); closeOffcanvas();">
                    <span class="icon"><i class="bi bi-pen"></i></span>
                    <span class="description">Returned Books</span> <span class="right-align"> > </span>
                </button>
            </nav>
    ...
    <div class="main-content">
        ...
        <div id="section-toreturn" class="section">
            <div class="panel">
                ...
                <button class="btn btn-success btn-mark" disabled id="toMarkReturned" type="submit" form="toReturn">
                    <i class="bi bi-check-circle me-2"></i>Mark returned
                </button>
